...
{ 
	...
	// <column type="widestr" desc="Ãû×Ö"/> 
	COLUMN_ASURABOSS_ATTACK_LIST_REC_NAME, 
 
	// <column type="dword" desc="ÕóÓª"/> 
	COLUMN_ASURABOSS_ATTACK_LIST_REC_CAMP, 
 
	// <column type="dword" desc="ÉËº¦"/> 
...
{ 
	...
	COLUMN_WORLDBOSS_ATTACK_LIST_REC_¶ÔÏóÃû×Ö, 
 
	// <column type="dword" desc=""/> 
	COLUMN_WORLDBOSS_ATTACK_LIST_REC_×ÜÉËº¦Öµ, 
...
{ 
	...
	// <column type="dword" desc="»ý·Ö"/> 
	COLUMN_ASURA_FIGHT_REC_SCORE, 
 
	// <column type="dword" desc="É±ÈËÊý"/> 
	COLUMN_ASURA_FIGHT_REC_KILL, 
 
	// <column type="dword" desc="ËÀÍöÊý"/> 
	COLUMN_ASURA_FIGHT_REC_DEAD, 
 
	// <column type="dword" desc="Öú¹¥Êý"/> 
...
{ 
	...
	// <column type="object" desc="Íæ¼Ò¶ÔÏó"/> 
...
{ 
	...
	// <column type="WORD" desc="Íâ¹ÛÀàÐÍ"/> 
...
{ 
	...
	// <column type="dword" desc="²É¼¯×ÜÊý"/> 
	COLUMN_CAMP_FIGHT_REC_NUM, 
 
	// <column type="dword" desc="ÕóÓª»ý·Ö"/> 
	COLUMN_CAMP_FIGHT_REC_SCORE, 
 
	// <column type="dword" desc="²É¼¯½×¶Î"/> 
...
{ 
	...
	// <column type="widestr" desc="Íæ¼ÒÃû"/> 
	COLUMN_BLUE_SCORE_REC_PLAYER, 
 
	// <column type="int" desc="»ý·Ö"/> 
	COLUMN_BLUE_SCORE_REC_SCORE, 
 
	// <column type="int" desc="É±ÈËÊý"/> 
	COLUMN_BLUE_SCORE_REC_KILL, 
 
	// <column type="int" desc="ËÀÍöÊý"/> 
	COLUMN_BLUE_SCORE_REC_DEAD, 
 
	// <column type="int" desc="Öú¹¥Êý"/> 
...
{ 
	...
	// <column type="object" desc="¾«Ó¢¹Ö¶ÔÏóºÅ"/> 
	COLUMN_WORLD_BOSS_ELITE_NPC_REC_NPC, 
 
	// <column type="int" desc="¾«Ó¢¹ÖÐòºÅ"/> 
