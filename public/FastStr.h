...
public:
    ...
    /*
    size_t resize(size_t size) const
    {
        TYPE* src = m_pData;
        size_t old_size = m_nSize;
...
typedef TFastStr<char, 128> return_string;
typedef TFastStr<wchar_t, 128> return_wstring;

#endif // _PUBLIC_FASTSTR_H
