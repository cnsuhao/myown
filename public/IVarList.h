...
#ifndef _PUBLIC_IVARLIST_H
#define _PUBLIC_IVARLIST_H
...
public:
	...
	inline IVarList& operator<<(const std::wstring& value) 
	{ 
		AddWideStr(value.c_str()); 
		return *this; 
	}
	inline IVarList& operator<<(const return_string& value) 
	{ 
		AddString(value.c_str()); 
		return *this; 
	}
	inline IVarList& operator<<(const return_wstring& value) 
	{ 
		AddWideStr(value.c_str()); 
		return *this; 
	}
