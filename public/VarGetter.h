...
#ifndef _PUBLIC_VARGETTER_H
#define _PUBLIC_VARGETTER_H
...
template<>
struct TVarGetter<const std::string&>
{
	static const char* Get(const IVar& v)
	{
		return v.StringVal();
...
template<>
struct TVarGetter<const std::wstring&>
{
	static const wchar_t* Get(const IVar& v)
	{
		return v.WideStrVal();
...
template<>
struct TVarGetter<return_string>
{
	static const char* Get(const IVar& v)
	{
		return v.StringVal();
...
template<>
struct TVarGetter<const return_string&>
{
	static const char* Get(const IVar& v)
	{
		return v.StringVal();
...
template<>
struct TVarGetter<return_wstring>
{
	static const wchar_t* Get(const IVar& v)
	{
		return v.WideStrVal();
...
template<>
struct TVarGetter<const return_wstring&>
{
	static const wchar_t* Get(const IVar& v)
	{
		return v.WideStrVal();
