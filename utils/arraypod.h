...
#ifndef _UTILS_ARRAYPOD_H
#define _UTILS_ARRAYPOD_H
...
public:
	...
	void push_back(const TYPE& data)
	{
		if (m_nSize == m_nCapacity)
		{
			...
			TYPE* p = (TYPE*)m_Alloc.Alloc(sizeof(TYPE) * new_size);
	...
	void reserve(size_t size)
	{
		if (size > m_nCapacity)
		{
			TYPE* p = (TYPE*)m_Alloc.Alloc(sizeof(TYPE) * size);
